...
public class vtigerListners extends BaseClassForVtiger implements ITestListener {
		...
		public void onStart(ITestContext context) {
			...
			spark = new ExtentSparkReporter("./Vtiger/Report");
			spark.config().setDocumentTitle("taskNo7,8");
